...
namespace TicketsDump
{
    public class LSA
    {
        ...
        public static void DisplayTicket(KRB_CRED cred, int indentLevel = 2, bool displayTGT = true, bool displayB64ticket = false, bool extractKerberoastHash = true, bool nowrap = false, byte[] serviceKey = null, byte[] asrepKey = null, string serviceUser = "", string serviceDomain = "", byte[] krbKey = null, byte[] keyList = null, string desPlainText = "")
        {
            // displays a given .kirbi (KRB_CRED) object, with display options
                                                ...
                                                if (elt2.TagValue == 3)
                                                {
                                                    ...
                                                    if (cksumtype == 0x8003)
                                                    {
                                                        ...
                                                        if ((checksumBytes[20] & 1) == 1)
                                                        {
                                                            ...
                                                            DisplayTicket(kirbi, 2, false, false, false, false, null, key);
